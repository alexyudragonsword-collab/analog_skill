"""amp_fan_smc — Fan SMC, 3-stage single-Miller-capacitor + feedforward.

Device-for-device the same bias / cascoded-input / stage-2 / stage-3
skeleton as Leung NMCF (bias diode net013, VB3/VB4 NMOS bias, PMOS pair
into NMOS cascode mid-nodes, gm2 + LOAD2 mirror, gm3 + gmf2 output), but
with a SINGLE compensation cap: C0 net050 -> VOUT.  No inner Miller cap.
"""
import sys
